...
export default function Home() {
  ...
  const filtered = useMemo(() => products.filter((p) => (category === "All" || p.category === category) && `${p.name} ${p.note}`.toLowerCase().includes(query.toLowerCase())), [hostedProducts, category, query]);
